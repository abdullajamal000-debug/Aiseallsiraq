...
أريد منك إنشاء إعلان تسويقي باللهجة العراقية، مناسب للنشر على Instagram وFacebook.

اكتب النتيجة بهذا الترتيب:

اسم المنتج:
إذا كان الاسم واضحاً في الصورة اكتبه.
إذا لم يكن واضحاً اكتب: غير واضح.

وصف المنتج:
وصف قصير وجذاب اعتماداً فقط على المعلومات الظاهرة في الصورة.

الكابشن:
اكتب كابشن عراقي جذاب جداً وبيعي.
استخدم الإيموجي بشكل مناسب.
خلي الأسلوب يخلي الزبون يرغب بالشراء.

السعر:
{price} د.ع

دعوة للشراء:
جملة قصيرة تشجع الزبون على الطلب.
